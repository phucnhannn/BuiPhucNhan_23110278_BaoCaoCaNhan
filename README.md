...
Thông qua project này, đã có cái nhìn tổng quan và thực tế hơn về các phương pháp giải quyết bài toán 8-Puzzle, đồng thời rút ra được kinh nghiệm trong việc áp dụng và so sánh các thuật toán trí tuệ nhân tạo.
## 3.2 Hướng phát triển
Trong tương lai, project có thể được mở rộng để giải các biến thể lớn hơn như 15-Puzzle hoặc 24-Puzzle nhằm đánh giá hiệu quả của các thuật toán trên không gian trạng thái phức tạp hơn. Ngoài ra, có thể thử nghiệm các thuật toán hiện đại như Deep Reinforcement Learning hoặc kết hợp nhiều chiến lược heuristic để nâng cao chất lượng và tốc độ lời giải. Việc tối ưu hóa bộ nhớ, cải thiện hiệu năng và bổ sung các chức năng so sánh, trực quan hóa kết quả cũng là những hướng phát triển tiềm năng cho project này.